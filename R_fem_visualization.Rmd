---
title: "Visualization"
author: "R-Ladies | R-Fem Davis Chapter"
date: "10/26/2018"
...
```{r Set-up, eval=FALSE, warning=FALSE, message=FALSE, results='hide'}
...
```{r leg, eval=FALSE, warning=FALSE, message=FALSE, results='hide'}
...
```{r drought, eval=FALSE, warning=FALSE, message=FALSE, results='hide'}
...
```{r angel, eval=FALSE, warning=FALSE, message=FALSE, results='hide'}
...
```{r quick, eval=FALSE, warning=FALSE, message=FALSE, results='hide'}
...
```{r baltimore, eval=FALSE, warning=FALSE, message=FALSE, results='hide'}
...
```{r barplot, eval=FALSE, warning=FALSE, message=FALSE, results='hide'}
...
```{r theme, eval=FALSE, warning=FALSE, message=FALSE, results='hide'}
...
```{r colors, eval=FALSE, warning=FALSE, message=FALSE, results='hide'}
...
```{r orgs, eval=FALSE, warning=FALSE, message=FALSE, results='hide'}
